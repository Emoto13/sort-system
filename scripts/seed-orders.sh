...
grpcurl -d "{\"orderId\":  \"1\"}" -plaintext localhost:10001 fulfillment.Fulfillment.GetFulfillmentStatusByOrderId
grpcurl -d "{}" -plaintext localhost:10001 fulfillment.Fulfillment.GetAllOrdersFulfillmentStatus
